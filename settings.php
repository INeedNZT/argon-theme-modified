...
<script src="<?php bloginfo('template_url'); ?>/assets/vendor/jquery/jquery.min.js"></script>
	...
	<div>
		...
		<p style="margin-top: 20px;">
			<a href="https://github.com/INeedNZT/argon-theme-modified/" target="_blank" style="box-shadow: none;text-decoration: none;">
				...
				<span style="font-size: 20px;transform: translate(5px,-9px);display: inline-block;">INeedNZT/argon-theme-modified</span>
			</a>
		</p>
