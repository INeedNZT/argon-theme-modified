...
function searchPosts(word){
	if ($(".search-result").length > 0){
		...
		$.pjax({
			url: argonConfig.lang_home + "?s=" + encodeURI(word)
		});
	}
}
/*顶栏搜索*/
...
/*Console*/
!function(){
	console.log('%cTheme: %cArgon%cBy INeedNZT', 'color: rgba(255,255,255,.6); background: #5e72e4; font-size: 15px;border-radius:5px 0 0 5px;padding:10px 0 10px 20px;','color: rgba(255,255,255,1); background: #5e72e4; font-size: 15px;border-radius:0;padding:10px 15px 10px 0px;','color: #fff; background: #92A1F4; font-size: 15px;border-radius:0 5px 5px 0;padding:10px 20px 10px 15px;');
	...
	console.log('%chttps://github.com/INeedNZT/argon-theme-modified', 'font-size: 12px;border-radius:5px;padding:3px 10px 3px 10px;border:1px solid #5e72e4;');
}();
