		...
		<?php
			foreach ($emotionList as $groupIndex => $group){ 
				...
				foreach ($group['list'] as $index => $emotion){
					...
					if ($emotion['type'] == 'sm_sticker'){
						echo "<div class='emotion-item emotion-item-sticker sm' code='" . $emotion['code'] . "' title='" . esc_attr($title) . "'><img class='lazyload' src='data:image/svg+xml;base64,' data-original='" . $emotion['src'] . "'/></div>";
					}
				}
