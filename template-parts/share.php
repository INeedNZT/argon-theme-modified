<div id="share_container">
	<div id="share" data-initialized="true">
			...
			<a class="no-pjax icon-wechat" tooltip="<?php _e('分享到 微信', 'argon'); ?>">
				<button class="btn btn-icon btn-success">
					<span class="btn-inner--icon"><i class="fa fa-weixin"></i></span>
				</button>
			</a>
			<a target="_blank" class="no-pjax icon-douban" tooltip="<?php _e('分享到 豆瓣', 'argon'); ?>">
			...
			<a target="_blank" class="no-pjax icon-weibo" tooltip="<?php _e('分享到 微博', 'argon'); ?>">
