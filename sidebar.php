...
<aside id="leftbar" class="leftbar widget-area" role="complementary">
		<?php if (argon_sidebar_announcement() != '') { ?>
			<div id="leftbar_announcement" class="card bg-white shadow-sm border-0">
				<div class="leftbar-announcement-body">
					<div class="leftbar-announcement-title text-white"><?php _e('公告', 'argon');?></div>
					<div class="leftbar-announcement-content text-white"><?php echo argon_sidebar_announcement(); ?></div>
				</div>
			</div>
		<?php } ?>
		<div id="leftbar_part1" class="widget widget_search card bg-white shadow-sm border-0">
			<div class="leftbar-banner card-body">
				<span class="leftbar-banner-title text-white"><?php echo argon_sidebar_banner_title(); ?></span>

				<?php 
					$sidebar_subtitle = argon_sidebar_banner_subtitle(); 
				...
				<div>
					<div class="tab-content" style="padding: 10px 10px 0 10px;">
						...
						<div class="tab-pane fade text-center<?php if ($nowActiveTab == 1) { echo ' active show'; }?>" id="leftbar_tab_overview" role="tabpanel" aria-labelledby="leftbar_tab_overview_btn">
							...
							<h6 id="leftbar_overview_author_name"><?php echo argon_sidebar_auther_name(); ?></h6>
							<?php $author_desctiption = argon_sidebar_author_description(); if (!empty($author_desctiption)) {echo '<h6 id="leftbar_overview_author_description">'. $author_desctiption .'</h6>';}?>
